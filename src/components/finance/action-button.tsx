...
// toast on success/failure — same shape as examinations'
// FinalizeScoreButton and library's LibraryActionButton, parameterized
// over the action/label since Issue/Cancel are otherwise identical.
