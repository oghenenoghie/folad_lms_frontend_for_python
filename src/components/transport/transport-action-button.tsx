...
// library's LibraryActionButton, hostel's HostelActionButton, and
// inventory's InventoryActionButton. Used here for unassigning a student
// from transport, which takes no input.
export function TransportActionButton({
  label,
  icon,
  variant = "secondary",
  action,
